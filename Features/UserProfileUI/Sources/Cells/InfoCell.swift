...
#warning ("Убрать заглушку")
    ...
    override init(style: UITableViewCell.CellStyle, reuseIdentifier: String?) {
        ...
        avatarImageView.layer.cornerRadius = Constants.AvatarImageView.cornerRadius
    ...
    private func setupAvatarImageViewConstraints() {
        ...
        NSLayoutConstraint.activate([
            avatarImageView.leadingAnchor.constraint(equalTo: contentView.leadingAnchor, constant: Constants.AvatarImageView.leadingAnchorConstant),
    ...
    private func setupNameLabelConstraints() {
        ...
        NSLayoutConstraint.activate([
            nameLabel.topAnchor.constraint(equalTo: contentView.topAnchor, constant: Constants.NameLabel.topAnchorConstant),
    ...
    private func setupLocationLabelConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            locationLabel.trailingAnchor.constraint(equalTo: contentView.trailingAnchor, constant: Constants.LocationLabel.trailingAnchorConstant),
    ...
    private func setupEditButtonConstraints() {
        ...
        NSLayoutConstraint.activate([
            ...
            editButton.bottomAnchor.constraint(equalTo: contentView.bottomAnchor, constant: Constants.EditButton.bottomAnchorConstant),
